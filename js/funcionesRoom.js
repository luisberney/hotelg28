...
function pintarRoom(respuesta){
    ...
    myTable+='<thead><tr><th scope="col">#</th><th scope="col">Nombre de habitación</th><th scope="col">Estrellas</th><th scope="col">Hotel</th><th scope="col">Descripción</th><th scope="col">Categoría</th>';
    ...
    for(i=0;i<respuesta.length;i++){
        ...
        myTable+='<td> <button class="btn btn-success"  onclick="putRoom('+respuesta[i].id+')">Actualizar</button>';
        myTable+='<td> <button class="btn btn-danger" onclick="deleteRoom('+respuesta[i].id+')">Borrar</button>';
